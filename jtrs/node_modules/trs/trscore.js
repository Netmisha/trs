...
Logs.prototype.Create = function(){
	var date= new Date();
    this.file=this.dir+'/log_'+String(date.getDate())+'_'+(date.getMonth()+1<10?'0':'')+String(date.getMonth()+1)+'_'+String(date.getFullYear())+'_'+String(date.getHours())+'_'+String(date.getMinutes())+'_'+String(date.getSeconds())+'.log';
};
