...
Messages.prototype.ResultOk = function(process) {
	process.send({ msg:this.test+" OK" });
};
Messages.prototype.Fail = function(process, msg) {
	process.send({ msg:this.test+" Fail: "+msg });
};
Messages.prototype.Error = function(process, msg) {
	process.send({ msg:this.test+" Error: "+msg });
};
Messages.prototype.Msg = function(process, msg) {
	process.send({ msg:this.test+" Msg: "+msg });
};
...
function Manager() {
	if (os.platform()=="win32") {
        ...
        this.pause=Number(extendedData.suite.test[process.argv[3]].repeat[0].$.pause);
        this.repeat=Number(extendedData.suite.test[process.argv[3]].repeat[0]._);
        ...
        this.msg = new Messages(extendedData.suite.$.name, extendedData.suite.test[process.argv[3]].$.name);
    }
	else {
